...
### 目的
新しい機能や仕様変更、修正のためのステアリングファイルを作成します。
...
3. **テンプレートからファイル作成**
   ...
   - `.claude/skills/steering/templates/requirements.md` → `docs/.steering/[日付]-[作業名]/requirements.md`
...
```
Read('docs/.steering/[日付]-[作業名]/tasklist.md')
```
